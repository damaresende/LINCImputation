/**
* The class <code>Sub</code> extends the class <code>GPNode</code> and
* creates a function node that takes the difference of a two values
...
public class Sub extends GPNode{
    ...
    /**
	 * Node that represents subtraction operation
	 */
	private static final long serialVersionUID = -2378911132847960249L;
