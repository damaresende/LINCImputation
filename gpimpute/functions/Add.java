/**
* The class <code>Add</code> extends the class <code>GPNode</code> and
* creates a function node that sum up two values in the tree that 
...
public class Add extends GPNode {
    ...
    /**
	 * Node that represents addition operation
	 */
	private static final long serialVersionUID = 574509895688886008L;
