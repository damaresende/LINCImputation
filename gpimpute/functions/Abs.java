/**
* The class <code>Abs</code> extends the class <code>GPNode</code> and
* creates a function node that computes the absolute value of a value 
...
public class Abs extends GPNode {
    ...
    /**
	 * Node that represents absolute operation
	 */
	private static final long serialVersionUID = 5521641612640016170L;
