/**
* The class <code>Sin</code> extends the class <code>GPNode</code> and
* creates a function node that takes the sine of a value in the tree that 
...
public class Sin extends GPNode{
    ...
    /**
	 * Node that represents sine operation
	 */
	private static final long serialVersionUID = -3223379673949625156L;
